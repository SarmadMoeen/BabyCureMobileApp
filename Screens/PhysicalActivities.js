...
const PhysicalActivities = (props) => {
    ...
    useEffect(() => {
        ...
        fetch('http://10.135.49.117:3000/getPhysicalActivities')
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={{ flex: 0.60}}>
                ...
                props.navigation.navigate('PhysicalActivitiesMain', {title: item.title, description: item.description, uri: item.imageUrl })
